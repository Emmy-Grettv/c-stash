            ...
            <View style={styles.heroSection}>
             ...
             <View style={styles.section}>
                 ...
                 <TouchableOpacity
                    ...
                    onPress={() => navigation.navigate("Ewallet")} // <-- your next screen
                >
...
const styles = StyleSheet.create({
    ...
    logoText: { color: "#FF650E", fontSize: 24, fontWeight: "700" },
    ...
    heroText: { fontSize: 18, fontWeight: "bold", lineHeight: 26, color: "#333", textAlign: "center", maxWidth: 320 },
    getStartedBtn: { backgroundColor: "#FF650E", borderRadius: 12, paddingVertical: 16, paddingHorizontal: 32, width: "100%", maxWidth: 320, alignItems: "center" },
